...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TimeSlider = __webpack_require__(159);

	var _TimeSlider2 = _interopRequireDefault(_TimeSlider);

	var _NavTab = __webpack_require__(161);

	var _NavTab2 = _interopRequireDefault(_NavTab);

	var _AdvancedDataTable = __webpack_require__(162);

	var _AdvancedDataTable2 = _interopRequireDefault(_AdvancedDataTable);

	var _ReactActions = __webpack_require__(163);

	var _ReactStores = __webpack_require__(165);
	...
	var Typhoon = exports.Typhoon = function (_Component) {
	    ...
	    Typhoon.prototype.handleSubmit = function handleSubmit(event, params) {
	        ...
	        var cscj = _refs.cscj;
	        //http://localhost:8576/u/?u=

	        $.getJSON('http://192.168.116.86:1005/api/v1/typhoon', null, function (result) {
	            result = result.data;
	            result[0].checked = result[0].change = true;
	            _this2.onTyphoonItemCheck(result[0], null, [result[0]]);
	            tflist.setState({ dataProvider: result });
	        });
	        $.getJSON('http://192.168.116.86:1005/api/v1.1/basic/data?key=select_typhoon_city_list', null, function (result) {
	    ...
	    Typhoon.prototype.onTyphoonItemCheck = function onTyphoonItemCheck(data, column, selItems) {
	        ...
	        var ljxx = this.refs.ljxx;
	        var tf = selItems[selItems.length - 1] || false;
	        var typhoonLayer = leaf.typhoonLayer;

	        if (tf) {
	            var tfbh = leaf.tfbh = tf.tfbh;
	            $.getJSON('http://192.168.116.86:1005/api/v1/typhoon?history=true&tfbh=' + tfbh, null, function (result) {
	                result = result.data;
	...
	// DOMContentLoaded之后执行：等待action和stores的装载 ie8不支持
	...
	leaf.addTo = function (app, mapbox) {
	    ...
	    // ReactDOM.render(
	    //     <Typhoon height={offsetHeight} />,
	    //     app
	    // );
	    _reactDom2.default.render(_react2.default.createElement(_TimeSlider2.default, { expanded: true }), document.getElementById('control'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TimeSlider = function (_Component) {
	    ...
	    TimeSlider.prototype.drawTrack = function drawTrack() {
	        ...
	        if (expanded && canvas) {
	            (function () {
	                var ctx = canvas.getContext('2d'),
	                    ...
	                    img = new Image(),
	                    w = getWidth();
	                img.src = "assets/timeslider/pointer.png";
	                img.onload = function () {
	                    ...
	                    ctx.beginPath();
	                    ctx.bezierCurveTo(5, 13, 0, 7, 5, 5);
	                    ctx.lineTo(w - 5, 5);

	                    ctx.bezierCurveTo(w - 5, 0, w, 7, w - 5, 13);
	                    ctx.lineTo(5, 13);
	                    ctx.fillStyle = "#FFD633"; //gradient
	                    ctx.fill();
	    ...
	    TimeSlider.prototype.render = function render() {
	        ...
	        if (!expanded) {
	            return _react2.default.createElement('img', { src: 'assets/timeslider/collpase.png', onClick: this.expand.bind(this) });
	        }
	        width = width || 1800;
	        return _react2.default.createElement(
	            'div',
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement('img', { src: 'assets/timeslider/title-bg.png', onClick: this.collpase.bind(this) }),
	                _react2.default.createElement('img', { style: { width: width - 117 - 5, height: 34 }, src: 'assets/timeslider/bar-top.png' }),
	                _react2.default.createElement(
	                    'span',
	            ...
	            _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement('img', { style: { width: width - 5, height: 80 }, src: 'assets/timeslider/bar-middle.png' }),
	                _react2.default.createElement('img', { style: { position: "absolute", width: 5, height: 110, top: 4 }, src: 'assets/timeslider/bar-right.png' })
	            ),
	            _react2.default.createElement(
	                'div',
	                { style: { position: "absolute", left: 0, top: 45 } },
	                _react2.default.createElement('img', { src: 'assets/timeslider/play.png' }),
	                _react2.default.createElement(
	                    'div',
	                    { style: { display: 'inline-block', position: "relative", left: 5, top: -20 } },
	                    _react2.default.createElement('img', { src: 'assets/timeslider/track-left.png' }),
	                    _react2.default.createElement('img', { style: { width: width - 80, height: 10 }, src: 'assets/timeslider/track-middle.png' }),
	                    _react2.default.createElement('img', { src: 'assets/timeslider/track-right.png' })
	                ),
	                _react2.default.createElement('canvas', { style: { position: "relative", left: 55, top: -36 }, ref: 'track', width: width - 69, height: 16 })
	            )
	        );
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavTab = function (_Component) {
	    ...
	    NavTab.prototype.render = function render() {
	        ...
	        return _react2.default.createElement(
	            "div",
	            { className: "NavTab", style: { height: height || 50, backgroundColor: '#5190C7' } },
	            _react2.default.createElement(
	                "ul",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AdvancedDataTable = function (_Component) {
	    ...
	    AdvancedDataTable.prototype.onCheck = function onCheck(column, data) {
	        ...
	        var state = this.state;
	        var selItems = state.selItems;
	        var index = selItems.indexOf(data);
	        if (checked && index === -1) {
	    ...
	    AdvancedDataTable.prototype.getEventInfo = function getEventInfo(event) {
	        ...
	        var td = event.target;
	        var rowid = td.parentElement.rowIndex;
	        if (!dataProvider) {
	            return {};
	        }
	        info.target = td;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DataTableActions = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DataTableReducer = __webpack_require__(179);
